  ...
  <div class="flex flex-col justify-center items-center mb-8">
      ...
      >
        ...
        <div class="text-box h-3/5 flex flex-col justify-center items-center">
          ...
          <p class="text-sm w-11/12 text-center pb-3">
            ...
            transfer and request loans. Check test it out with username "kw" and
            password "1111" and/or username: "jd" and password: "2222" (but
    ...
    >
      ...
      >
        ...
        >
          <img class="picture" src="../../../assets/img/Mapty.png" alt="Mapty"
        /></a>
        <div class="text-box h-3/5 flex flex-col justify-center items-center">
